...
//   // Uses the Apollo useMutation hook
...
//     // Call the saveBook mutation here
...
//     if (data) {
//       // If the book is successfully saved, update state with the saved book ID
...
const SearchBooks = () => {
  ...
  // Modify handleSaveBook to use the saveBook mutation
  const handleSaveBook = async (bookId: string) => {
    const bookToSave: Book = searchedBooks.find((book) => book.bookId === bookId)!;
